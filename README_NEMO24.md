...
```
fine-tune-demo/
├── finetune_pipeline_nemo24.py    # Main NeMo 24.07 pipeline
├── configs/
...
├── docker_start_nemo24.sh         # Docker startup script
├── quick_start_nemo24.sh           # Interactive setup
...
python finetune_pipeline_nemo24.py --model codellama-13b --check-hardware

# Run fine-tuning
python finetune_pipeline_nemo24.py \
    --model codellama-13b \
...
python finetune_pipeline_nemo24.py --model llama3-70b --check-hardware
```
